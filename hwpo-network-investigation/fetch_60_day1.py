#!/usr/bin/env python3
"""Test the app's date-and-plan endpoint for the inferred 60 1.0 Day 1."""
...
OUTPUT = Path(__file__).resolve().parent / "hwpo-60-inferred-day-1.json"


def main() -> int:
    print("Target: 60 1.0, inferred Day 1 (2023-12-25)")
    ...
    try:
        ...
        result = request_json("athlete/schedules/2023-12-25/plans/77", token=token)
