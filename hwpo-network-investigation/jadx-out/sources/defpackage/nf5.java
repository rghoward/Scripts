...
public final class nf5 extends m2<Integer> implements zi5.b, RandomAccess, k98 {
    public static final nf5 w = new nf5(new int[0], 0, false);
    public int[] u;
    public int v;
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        ...
        collection.getClass();
        if (!(collection instanceof nf5)) {
            return super.addAll(collection);
        }
        nf5 nf5Var = (nf5) collection;
        int i = nf5Var.v;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(nf5Var.u, 0, this.u, this.v, nf5Var.v);
        this.v = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    @Override // defpackage.m2, java.util.AbstractList, java.util.Collection, java.util.List
    ...
    @Override // zi5.c
    public final zi5.c<Integer> h(int i) {
        if (i >= this.v) {
            return new nf5(Arrays.copyOf(this.u, i), this.v, true);
        }
        zn3.b();
        return null;
    }
    ...
    public nf5(int[] iArr, int i, boolean z) {
        super(z);
        this.u = iArr;
        this.v = i;
    }
