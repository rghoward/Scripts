...
public final class pt3 implements Interpolator {
    ...
    public final float getInterpolation(float f) {
        ...
        float[] fArr = a;
        float f3 = fArr[iMin];
        return go.a(fArr[iMin + 1], f3, f2, f3);
    }
}
