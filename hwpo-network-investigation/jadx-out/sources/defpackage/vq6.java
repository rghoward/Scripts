...
public final class vq6 implements kx6<Uri, InputStream> {
    ...
    public final kx6.a<InputStream> a(Uri uri, int i, int i2, xk7 xk7Var) {
        Long l;
        Uri uri2 = uri;
        if (i == Integer.MIN_VALUE || i2 == Integer.MIN_VALUE || i > 512 || i2 > 384 || (l = (Long) xk7Var.c(reb.d)) == null || l.longValue() != -1) {
            return null;
        }
        ke7 ke7Var = new ke7(uri2);
        Context context = this.a;
        return new kx6.a<>(ke7Var, mla.d(context, uri2, new mla.b(context.getContentResolver())));
    }
