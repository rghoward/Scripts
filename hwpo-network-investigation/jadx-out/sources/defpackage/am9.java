...
public class am9<T> extends s2<cm9> implements f37<T>, r54, ri4<T> {
    public Object[] A;
    public long B;
    public long C;
    public int D;
    ...
    public static final class a implements e33 {
        ...
        public a(am9 am9Var, long j, Object obj, e41 e41Var) {
            this.t = am9Var;
            this.u = j;
            this.v = obj;
            this.w = e41Var;
        ...
        public final void dispose() {
            ...
            synchronized (am9Var) {
                try {
                    if (this.u >= am9Var.r()) {
                        Object[] objArr = am9Var.A;
                        objArr.getClass();
                        long j = this.u;
                        if (objArr[((int) j) & (objArr.length - 1)] == this) {
                            ty1.c(objArr, j, ty1.d);
                            am9Var.m();
                        }
                    }
                    g2b g2bVar = g2b.a;
    ...
    public am9(int i, int i2, xx0 xx0Var) {
        this.x = i;
        this.y = i2;
        this.z = xx0Var;
    }
    ...
    public static void n(am9 am9Var, s54 s54Var, r02 r02Var) throws Throwable {
        bm9 bm9Var;
        am9 am9Var2;
        Throwable th;
        cm9 cm9Var;
        ...
        el5 el5Var;
        s54 s54Var3;
        if (r02Var instanceof bm9) {
            bm9Var = (bm9) r02Var;
            int i = bm9Var.z;
            if ((i & Integer.MIN_VALUE) != 0) {
                bm9Var.z = i - Integer.MIN_VALUE;
            } else {
                bm9Var = new bm9(am9Var, r02Var);
            }
        } else {
            bm9Var = new bm9(am9Var, r02Var);
        }
        ...
        if (i2 != 0) {
            if (i2 == 1) {
                cm9Var = bm9Var.v;
                s54 s54Var4 = bm9Var.u;
                am9 am9Var3 = bm9Var.t;
                try {
                    dv8.b(obj);
                    s54Var2 = s54Var4;
                    am9Var = am9Var3;
                    try {
                        el5Var = (el5) bm9Var.getContext().d0(el5.a.t);
                        s54Var3 = s54Var2;
                    } catch (Throwable th2) {
                        am9Var2 = am9Var;
                        th = th2;
                ...
                el5 el5Var2 = bm9Var.w;
                cm9Var = bm9Var.v;
                s54 s54Var5 = bm9Var.u;
                am9Var2 = bm9Var.t;
                try {
                    dv8.b(obj);
                    s54Var3 = s54Var5;
        ...
        dv8.b(obj);
        cm9 cm9VarH = am9Var.h();
        try {
            if (s54Var instanceof k4a) {
                bm9Var.t = am9Var;
                bm9Var.u = s54Var;
                bm9Var.v = cm9VarH;
                bm9Var.z = 1;
                if (((k4a) s54Var).a(bm9Var) == v72Var) {
                    return;
                }
            }
            s54Var2 = s54Var;
        ...
        while (true) {
            ...
            if (objV == ty1.d) {
                ...
                bm9Var.w = el5Var;
                bm9Var.z = 2;
                if (am9Var.l(cm9Var, bm9Var) == v72Var) {
                    return;
                }
            } else {
                ...
                bm9Var.w = el5Var;
                bm9Var.z = 3;
                if (s54Var3.emit(objV, bm9Var) == v72Var) {
                    return;
                }
            }
        }
    ...
    public final List<T> a() {
        synchronized (this) {
            int iR = (int) ((r() + ((long) this.D)) - this.B);
            if (iR == 0) {
                return hf3.t;
            }
            ...
            objArr.getClass();
            for (int i = 0; i < iR; i++) {
                arrayList.add(objArr[((int) (this.B + ((long) i))) & (objArr.length - 1)]);
            }
            return arrayList;
        }
    }
    ...
    public final void d() throws Throwable {
        ...
        synchronized (this) {
            try {
                am9Var = this;
                try {
                    am9Var.w(r() + ((long) this.D), this.C, r() + ((long) this.D), r() + ((long) this.D) + ((long) this.E));
                    g2b g2bVar = g2b.a;
                } catch (Throwable th) {
                    th = th;
                    Throwable th2 = th;
    ...
    public final Object emit(T t, r02<? super g2b> r02Var) throws Throwable {
        ...
        e41Var.t();
        r02<g2b>[] r02VarArrQ2 = t2.t;
        synchronized (this) {
            try {
                if (t(t)) {
                    try {
                        e41Var.resumeWith(g2b.a);
                        r02VarArrQ = q(r02VarArrQ2);
                        aVar = null;
                        am9Var = this;
                    } catch (Throwable th2) {
                        th = th2;
                    ...
                    try {
                        am9Var = this;
                        try {
                            a aVar2 = new a(am9Var, r() + ((long) (this.D + this.E)), t, e41Var);
                            am9Var.p(aVar2);
                            am9Var.E++;
                            if (am9Var.y == 0) {
                                r02VarArrQ2 = am9Var.q(r02VarArrQ2);
                            }
                            r02VarArrQ = r02VarArrQ2;
                            aVar = aVar2;
                        } catch (Throwable th3) {
                            th = th3;
                            th = th;
                ...
                for (r02<g2b> r02Var2 : r02VarArrQ) {
                    if (r02Var2 != null) {
                        r02Var2.resumeWith(g2b.a);
                    }
                }
    ...
    public final boolean f(T t) {
        int i;
        boolean z;
        r02<g2b>[] r02VarArrQ = t2.t;
        synchronized (this) {
            if (t(t)) {
                r02VarArrQ = q(r02VarArrQ);
                z = true;
            } else {
                z = false;
            }
        }
        for (r02<g2b> r02Var : r02VarArrQ) {
            if (r02Var != null) {
    ...
    public final Object l(cm9 cm9Var, bm9 bm9Var) throws Throwable {
        e41 e41Var = new e41(1, th0.e(bm9Var));
        e41Var.t();
        synchronized (this) {
            try {
                if (u(cm9Var) < 0) {
    ...
    public final void m() {
        if (this.y != 0 || this.E > 1) {
            ...
            while (this.E > 0) {
                ...
                int i = this.D;
                int i2 = this.E;
                if (objArr[((int) ((jR + ((long) (i + i2))) - 1)) & (objArr.length - 1)] != ty1.d) {
                    return;
                }
                this.E = i2 - 1;
                ty1.c(objArr, r() + ((long) (this.D + this.E)), null);
            }
        }
    }
    ...
    public final void o() {
        ...
        if (this.C < jR) {
            if (this.u != 0 && (objArr = this.t) != null) {
    ...
    public final void p(Object obj) {
        int i = this.D + this.E;
        Object[] objArrS = this.A;
        if (objArrS == null) {
            objArrS = s(0, 2, null);
        } else if (i >= objArrS.length) {
            objArrS = s(i, objArrS.length * 2, objArrS);
        }
        ty1.c(objArrS, r() + ((long) i), obj);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r11v0, types: [r02<g2b>[]] */
    ...
    public final r02<g2b>[] q(r02<g2b>[] r02VarArr) {
        Object[] objArr;
        cm9 cm9Var;
        e41 e41Var;
        ...
        if (this.u != 0 && (objArr = this.t) != null) {
            ...
            while (i < length2) {
                Object obj = objArr[i];
                if (obj == null || (e41Var = (cm9Var = (cm9) obj).b) == null || u(cm9Var) < 0) {
                    r02VarArr = r02VarArr;
                } else {
                    if (length >= r02VarArr.length) {
                        r02VarArr = r02VarArr;
                        r02VarArr = r02VarArr;
                        r02VarArr = Arrays.copyOf((Object[]) r02VarArr, Math.max(2, r02VarArr.length * 2));
                    }
                    r02VarArr = r02VarArr;
                    r02VarArr = r02VarArr;
                    ((r02[]) r02VarArr)[length] = e41Var;
                    cm9Var.b = null;
                    length++;
                }
                i++;
    ...
    public final Object[] s(int i, int i2, Object[] objArr) {
        ...
        if (objArr != null) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                long j = ((long) i3) + jR;
                ty1.c(objArr2, j, objArr[((int) j) & (objArr.length - 1)]);
            }
        }
        return objArr2;
    }
    ...
    public final boolean t(T t) {
        ...
        if (i2 != 0) {
            ...
            if (i4 < i5 || this.C > this.B) {
                ...
                j = this.B;
                if (((int) (jR - j)) > i3) {
                    w(1 + j, this.C, r() + ((long) this.D), r() + ((long) this.D) + ((long) this.E));
                }
            } else {
            ...
            this.C = r() + ((long) this.D);
            return true;
        }
        return true;
    }

    public final long u(cm9 cm9Var) {
        long j = cm9Var.a;
        if (j >= r() + ((long) this.D) && (this.y > 0 || j > r() || this.E == 0)) {
            return -1L;
        }
        return j;
    }

    public final Object v(cm9 cm9Var) {
        Object obj;
        r02<g2b>[] r02VarArrX = t2.t;
        synchronized (this) {
            try {
                long jU = u(cm9Var);
                if (jU < 0) {
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r14v6 ??, new type: long
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r19v6 ??, new type: long
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r5v10 ??, new type: long
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    jadx.core.utils.exceptions.JadxRuntimeException: Type update failed for variable: r5v17 ??, new type: long
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:109)
    	at jadx.core.dex.visitors.typeinference.TypeUpdate.apply(TypeUpdate.java:59)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.calculateFromBounds(TypeInferenceVisitor.java:147)
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.setBestType(TypeInferenceVisitor.java:125)
    ...
    /*  JADX ERROR: Types fix failed
        ...
        Caused by: java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "arg" is null
        	...
        	... 5 more
        */
    public final defpackage.r02<defpackage.g2b>[] x(long r22) {
        /*
            Method dump skipped, instruction units count: 264
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.am9.x(long):r02[]");
    }
}
