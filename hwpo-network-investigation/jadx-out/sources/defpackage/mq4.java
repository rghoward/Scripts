...
@xm2(c = "com.hwpo_training_app.affiliated_gym.data.repository.GymFiltersRepositoryImpl$getCountries$4", f = "GymFiltersRepositoryImpl.kt", l = {32}, m = "invokeSuspend", v = 2)
public final class mq4 extends p6a implements ei4<List<? extends GymFilterCountryNetworkEntity>, Integer, r02<? super g2b>, Object> {
    public int t;
    ...
    public mq4(fq4 fq4Var, r02<? super mq4> r02Var) {
        super(3, r02Var);
        this.w = fq4Var;
    }
    ...
    public final Object invoke(List<? extends GymFilterCountryNetworkEntity> list, Integer num, r02<? super g2b> r02Var) {
        ...
        mq4 mq4Var = new mq4(this.w, r02Var);
        mq4Var.u = list;
        mq4Var.v = iIntValue;
        return mq4Var.invokeSuspend(g2b.a);
    }
