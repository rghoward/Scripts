...
public final class u96 implements wfb {
    ...
    public u96(AspectRatioFrameLayout aspectRatioFrameLayout, AppCompatImageView appCompatImageView, AppCompatImageView appCompatImageView2, AppCompatImageView appCompatImageView3, AppCompatImageView appCompatImageView4) {
    ...
    public static u96 bind(View view) {
                ...
                if (((AspectRatioCardView) nt3.b(R.id.mediaAttachmentItem, view)) != null) {
                    ...
                    if (appCompatImageView3 != null) {
                        ...
                        if (appCompatImageView4 != null) {
                            return new u96((AspectRatioFrameLayout) view, appCompatImageView, appCompatImageView2, appCompatImageView3, appCompatImageView4);
                        }
                    }
                }
            }
    ...
    public static u96 inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.list_item_edit_performance_media_attachment, viewGroup, false);
        if (z) {
    ...
    public static u96 inflate(LayoutInflater layoutInflater) {
