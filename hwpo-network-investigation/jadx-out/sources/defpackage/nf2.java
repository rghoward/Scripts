...
public final class nf2 {
    ...
    public static zu6 b(MappedByteBuffer mappedByteBuffer) throws IOException {
        long j;
        ...
        if (j != -1) {
            ...
            for (int i4 = 0; i4 < j2; i4++) {
                ...
                if (1164798569 == i5 || 1701669481 == i5) {
                    ...
                    zu6Var.b = byteBufferDuplicate;
                    zu6Var.a = iPosition;
                    int i6 = iPosition - byteBufferDuplicate.getInt(iPosition);
                    zu6Var.c = i6;
                    zu6Var.d = zu6Var.b.getShort(i6);
                    return zu6Var;
                }
            }
        }
