...
public final class zx1 {
    ...
    public static final void k(int i, int i2) {
        throw new IllegalArgumentException(a30.b("Can't represent a width of ", " and height of ", " in Constraints", i, i2));
    }

    public static final Void l(int i) {
        throw new IllegalArgumentException(pk.d(i, "Can't represent a size of ", " in Constraints"));
    }
}
