...
public final class uq implements fl6 {
    ...
    public final gl6 d(hl6 hl6Var, List<? extends cl6> list, long j) {
        ...
        if3 if3Var = if3.t;
        if (size == 0) {
            return hl6Var.y0(0, 0, if3Var, a.u);
        }
        if (size == 1) {
            jz7 jz7VarE = list.get(0).E(j);
            return hl6Var.y0(jz7VarE.t, jz7VarE.u, if3Var, new b(jz7VarE));
        }
        ...
        for (int i = 0; i < size2; i++) {
            ...
            iMax = Math.max(iMax, jz7VarE2.t);
            iMax2 = Math.max(iMax2, jz7VarE2.u);
            arrayList.add(jz7VarE2);
        }
        return hl6Var.y0(iMax, iMax2, if3Var, new c(arrayList));
    }
}
