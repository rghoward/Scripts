...
public final class tq8 extends g5b<a, g2b> {
    public final sta a;
    ...
    public final Object a(a aVar, u02 u02Var) throws Throwable {
        uq8 uq8Var;
        if (u02Var instanceof uq8) {
            uq8Var = (uq8) u02Var;
            int i = uq8Var.v;
            if ((i & Integer.MIN_VALUE) != 0) {
                uq8Var.v = i - Integer.MIN_VALUE;
            } else {
                uq8Var = new uq8(this, u02Var);
            }
        } else {
            uq8Var = new uq8(this, u02Var);
        }
        ...
        if (i2 == 0) {
            ...
            String str = aVar.c;
            uq8Var.v = 1;
            Object objI = this.a.i(ebbVar, z, str, uq8Var);
            v72 v72Var = v72.t;
            if (objI == v72Var) {
                return v72Var;
            }
