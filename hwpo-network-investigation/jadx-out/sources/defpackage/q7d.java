...
public final class q7d {
    ...
    public static String b(Object obj) {
        ...
        try {
            ...
            String strA = w27.a(new StringBuilder(name.length() + 1 + String.valueOf(hexString).length()), name, "@", hexString);
            ...
            StringBuilder sb = new StringBuilder(strA.length() + 8 + name2.length() + 1);
            ux1.b(sb, "<", strA, " threw ", name2);
            sb.append(">");
            return sb.toString();
        }
    }
