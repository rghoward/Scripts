...
public final class n77 {
    public static Intent a(uy uyVar) {
        Intent parentActivityIntent = uyVar.getParentActivityIntent();
        if (parentActivityIntent != null) {
            return parentActivityIntent;
        }
        try {
            String strC = c(uyVar, uyVar.getComponentName());
            if (strC == null) {
                return null;
            }
            ComponentName componentName = new ComponentName(uyVar, strC);
            try {
                return c(uyVar, componentName) == null ? Intent.makeMainActivity(componentName) : new Intent().setComponent(componentName);
