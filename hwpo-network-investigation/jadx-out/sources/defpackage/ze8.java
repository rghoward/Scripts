...
public final class ze8<E> extends m2<E> implements RandomAccess {
    public static final ze8<Object> w = new ze8<>(new Object[0], 0, false);
    public E[] u;
    public int v;

    public ze8(E[] eArr, int i, boolean z) {
        super(z);
        this.u = eArr;
        this.v = i;
    }
    ...
    public final zi5.c h(int i) {
        if (i >= this.v) {
            return new ze8(Arrays.copyOf(this.u, i), this.v, true);
        }
        zn3.b();
        return null;
    }
