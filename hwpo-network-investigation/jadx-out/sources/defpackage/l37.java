...
public final class l37 {
    ...
    private static final void c(int i, int i2) {
        throw new IndexOutOfBoundsException(a30.b("Index ", " is out of bounds. The list has ", " elements.", i, i2));
    }

    private static final void d(int i) {
        throw new IndexOutOfBoundsException(pk.d(i, "fromIndex (", ") is less than 0."));
    }
    ...
    private static final void f(int i, int i2) {
        throw new IllegalArgumentException(a30.b("Indices are out of order. fromIndex (", ") is greater than toIndex (", ").", i, i2));
    }
}
