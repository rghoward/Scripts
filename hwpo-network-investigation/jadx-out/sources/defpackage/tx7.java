...
public final class tx7 extends yx4 {
    public static final /* synthetic */ ho5<Object>[] C = {new ne8(tx7.class, "binding", "getBinding()Lcom/hwpo_training_app/core/databinding/FragmentPhotoPreviewBinding;", 0)};
    ...
    /* JADX INFO: compiled from: r8-map-id-5f1ea74b072460be821fa7f2514cf36d220f69463b6062bff833a45851f543a6 */
    @xm2(c = "com.hwpo_training_app.core.photo_preview.presentation.PhotoPreviewFragment$initListeners$1", f = "PhotoPreviewFragment.kt", l = {}, m = "invokeSuspend", v = 2)
    public static final class b extends p6a implements ei4<t72, View, r02<? super g2b>, Object> {
        ...
        public final Object invoke(t72 t72Var, View view, r02<? super g2b> r02Var) {
            return tx7.this.new b(r02Var).invokeSuspend(g2b.a);
        }
    ...
    /* JADX INFO: compiled from: r8-map-id-5f1ea74b072460be821fa7f2514cf36d220f69463b6062bff833a45851f543a6 */
    public static final class c implements oh4<tx7, kf4> {
        @Override // defpackage.oh4
        public final kf4 invoke(tx7 tx7Var) {
            tx7 tx7Var2 = tx7Var;
            tx7Var2.getClass();
            return kf4.bind(tx7Var2.requireView());
        }
    }
    ...
    public static final class h extends wp5 implements mh4<thb.c> {
        ...
        public final thb.c invoke() {
            ...
            wt4 wt4Var = whbVar instanceof wt4 ? (wt4) whbVar : null;
            return (wt4Var == null || (defaultViewModelProviderFactory = wt4Var.getDefaultViewModelProviderFactory()) == null) ? tx7.this.getDefaultViewModelProviderFactory() : defaultViewModelProviderFactory;
        }
    }

    public tx7() {
        ss5 ss5VarC = hv5.c(j26.u, new e(new d()));
        this.B = new shb(ll8.a(vx7.class), new f(ss5VarC), new h(ss5VarC), new g(ss5VarC));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // defpackage.hk0
    public final void i() {
        xgb.a(((kf4) this.A.a(this, C[0])).b, new b(null));
    }

    @Override // defpackage.hk0
    public final void j() {
        ((vx7) this.B.getValue()).x.b();
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        vg4 vg4Var = this.A;
        ee5.a(new sx7(), ((kf4) vg4Var.a(this, ho5Var)).b);
        e85.b(((kf4) vg4Var.a(this, ho5VarArr[0])).c, requireArguments().getString("PHOTO_KEY", BuildConfig.FLAVOR), R.drawable.placeholder_image_attachment_huge, false);
    }
}
