...
public final class wx8 extends Drawable {
    public float a;
    ...
    public wx8(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void b(Rect rect) {
        ...
        if (this.f) {
            ...
            boolean z = this.g;
            if (z) {
                f = (float) (((1.0d - xx8.a) * ((double) f7)) + ((double) (1.5f * f6)));
            } else {
                int i = xx8.b;
                f = 1.5f * f6;
            }
            if (z) {
                f6 = (float) (((1.0d - xx8.a) * ((double) f7)) + ((double) f6));
            }
