...
public final class xk6 {
    ...
    public static final void c(float[] fArr, b37 b37Var) {
        if (fArr.length < 16) {
            return;
        }
        float f = fArr[0];
        ...
        b37Var.a = Math.min(f19, Math.min(f26, Math.min(f32, f37)));
        b37Var.b = Math.min(f22, Math.min(f28, Math.min(f34, f38)));
        b37Var.c = Math.max(f19, Math.max(f26, Math.max(f32, f37)));
        b37Var.d = Math.max(f22, Math.max(f28, Math.max(f34, f38)));
    }
