...
public final class IntercomBlocksAdminLayoutBinding implements wfb {
    ...
    public static IntercomBlocksAdminLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.intercom_blocks_admin_layout, viewGroup, false);
        if (z) {
