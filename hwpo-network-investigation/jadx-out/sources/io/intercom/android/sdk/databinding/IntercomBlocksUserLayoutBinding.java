...
public final class IntercomBlocksUserLayoutBinding implements wfb {
    ...
    public static IntercomBlocksUserLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.intercom_blocks_user_layout, viewGroup, false);
        if (z) {
