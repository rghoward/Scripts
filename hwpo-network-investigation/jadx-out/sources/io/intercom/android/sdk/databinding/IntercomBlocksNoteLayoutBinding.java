...
public final class IntercomBlocksNoteLayoutBinding implements wfb {
    ...
    public static IntercomBlocksNoteLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.intercom_blocks_note_layout, viewGroup, false);
        if (z) {
