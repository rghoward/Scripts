...
public final class IntercomBlocksArticleLayoutBinding implements wfb {
    ...
    public static IntercomBlocksArticleLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.intercom_blocks_article_layout, viewGroup, false);
        if (z) {
