...
public final class IntercomBlocksCarouselLayoutBinding implements wfb {
    ...
    public static IntercomBlocksCarouselLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.intercom_blocks_carousel_layout, viewGroup, false);
        if (z) {
