...
public final class HelpCenterScreenKt$HelpCenterNavGraph$1$1$5 implements fi4<nu, r47, jt1, Integer, g2b> {
    final /* synthetic */ List<String> $collectionIds;
    final /* synthetic */ Context $context;
    final /* synthetic */ o67 $navController;
    final /* synthetic */ HelpCenterViewModel $viewModel;

    public HelpCenterScreenKt$HelpCenterNavGraph$1$1$5(HelpCenterViewModel helpCenterViewModel, List<String> list, Context context, o67 o67Var) {
    ...
    public final void invoke(nu nuVar, r47 r47Var, jt1 jt1Var, int i) {
        ...
        String str = (String) th1.y(this.$collectionIds);
        jt1Var.K(-2112895338);
        ...
        if (zJ || objF == c0187a) {
            objF = new oh4() { // from class: io.intercom.android.sdk.m5.helpcenter.ui.h
                @Override // defpackage.oh4
                public final Object invoke(Object obj) {
                    return HelpCenterScreenKt$HelpCenterNavGraph$1$1$5.invoke$lambda$1$lambda$0(helpCenterViewModel2, context, (String) obj);
                }
            };
            jt1Var.C(objF);
        }
        ...
        if (zJ2 || objF2 == c0187a) {
            objF2 = new oh4() { // from class: io.intercom.android.sdk.m5.helpcenter.ui.i
                @Override // defpackage.oh4
                public final Object invoke(Object obj) {
                    return HelpCenterScreenKt$HelpCenterNavGraph$1$1$5.invoke$lambda$3$lambda$2(o67Var, (String) obj);
                }
            };
            jt1Var.C(objF2);
        }
