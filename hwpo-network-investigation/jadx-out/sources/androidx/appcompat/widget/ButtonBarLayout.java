...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.t = typedArrayObtainStyledAttributes.getBoolean(0, true);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int paddingBottom = 0;
        if (this.t) {
            if (size > this.v && this.u) {
                setStacked(false);
            }
            this.v = size;
        }
        if (this.u || View.MeasureSpec.getMode(i) != 1073741824) {
            iMakeMeasureSpec = i;
            z = false;
        } else {
        ...
        if (this.t && !this.u && (getMeasuredWidthAndState() & (-16777216)) == 16777216) {
            setStacked(true);
            z = true;
        }
        if (z) {
