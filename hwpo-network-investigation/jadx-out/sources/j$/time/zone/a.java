...
public final class a implements Externalizable {
    ...
    public static long a(DataInput dataInput) {
        int i = dataInput.readByte() & MessagePack.Code.EXT_TIMESTAMP;
        if (i == 255) {
            return dataInput.readLong();
        }
        return (((long) (((i << 16) + ((dataInput.readByte() & MessagePack.Code.EXT_TIMESTAMP) << 8)) + (dataInput.readByte() & MessagePack.Code.EXT_TIMESTAMP))) * 900) - 4575744000L;
    }
