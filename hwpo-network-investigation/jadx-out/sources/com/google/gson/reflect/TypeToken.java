...
public class TypeToken<T> {
    ...
    public static TypeToken<?> getParameterized(Type type, Type... typeArr) {
        ...
        if (!(type instanceof Class)) {
            u.c(type, "rawType must be of type Class, but was ");
            return null;
        }
        ...
        if (length2 != length) {
            hza.a(cls.getName(), " requires ", length, " type arguments, but got ", length2);
            return null;
        }
        if (typeArr.length == 0) {
            return get(cls);
        ...
        if (GsonTypes.requiresOwnerType(type)) {
            z.b(cls.getName(), " is not supported because it requires specifying an owner type", "Raw type ");
            return null;
        }
    ...
    private Type getTypeTokenTypeArgument() {
        ...
        if (genericSuperclass instanceof ParameterizedType) {
            ...
            v92.b(TroubleshootingGuide.createUrl("type-token-raw"), "TypeToken must be created with a type argument: new TypeToken<...>() {}; When using code shrinkers (ProGuard, R8, ...) make sure that generic signatures are preserved.\nSee ");
            return null;
        }
        aa0.c("Must only create direct subclasses of TypeToken");
        return null;
    }
    ...
    private static void verifyNoTypeVariable(Type type) {
        ...
        if (!(type instanceof WildcardType)) {
            ...
            z90.a("TypeToken captured `null` as type argument; probably a compiler / runtime bug");
            return;
        }
