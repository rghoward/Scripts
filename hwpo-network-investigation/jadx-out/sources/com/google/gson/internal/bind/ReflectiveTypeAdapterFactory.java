...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        public T finalize(Object[] objArr) {
            try {
                ...
                jl.a("Failed to invoke constructor '" + ReflectionHelper.constructorToString(this.constructor) + "' with args " + Arrays.toString(objArr), e4.getCause());
                return null;
            }
        }
        ...
        public void readField(Object[] objArr, JsonReader jsonReader, BoundField boundField) {
            ...
            aa0.c(av.a(sb, boundField.fieldName, "', unable to determine which argument in the constructor the field corresponds to. This is unexpected behavior, as we expect the RecordComponents to have the same names as the fields in the Java class, and that the order of the RecordComponents is the same as the order of the canonical constructor parameters."));
        }
    }
    ...
    public static <M extends AccessibleObject & Member> void checkAccessible(Object obj, M m) {
        ...
        if (!ReflectionAccessFilterHelper.canAccess(m, obj)) {
            throw new JsonIOException(al.d(ReflectionHelper.getAccessibleObjectDescription(m, true), " is not accessible and ReflectionAccessFilter does not permit making it accessible. Register a TypeAdapter for the declaring type, adjust the access filter or increase the visibility of the element and its declaring type."));
        }
    }
        ...
        return new BoundField(str, field) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.2
            ...
            public void readIntoField(JsonReader jsonReader, Object obj) throws IllegalAccessException {
                ...
                if (z2) {
                    ...
                    throw new JsonIOException(ct1.a("Cannot set value of 'static final' ", ReflectionHelper.getAccessibleObjectDescription(this.field, false)));
                }
            ...
            public void write(JsonWriter jsonWriter, Object obj) throws IllegalAccessException {
                ...
                if (method3 != null) {
                    try {
                        ...
                        throw new JsonIOException(sk0.c("Accessor ", ReflectionHelper.getAccessibleObjectDescription(method, false), " threw exception"), e.getCause());
                    }
                } else {
                ...
                if (zIncludeField || zIncludeField2) {
                    ...
                    if (!z2) {
                        ...
                        if (accessor.getAnnotation(SerializedName.class) != null && field.getAnnotation(SerializedName.class) == null) {
                            throw new JsonIOException(sk0.c("@SerializedName on ", ReflectionHelper.getAccessibleObjectDescription(accessor, z7), " is not supported"));
                        }
                        z3 = zIncludeField2;
                    }
                    if (!z8 && accessor == null) {
