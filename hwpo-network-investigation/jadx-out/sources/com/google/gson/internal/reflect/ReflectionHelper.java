...
public class ReflectionHelper {
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbA = aa.a("Failed making ", getAccessibleObjectDescription(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbA.append(getInaccessibleTroubleshootingSuffix(e));
            throw new JsonIOException(sbA.toString(), e);
        }
    }
