...
public final class LeaderboardFiltersFlowFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ LeaderboardFiltersFlowFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardFiltersFlowFragment$special$$inlined$viewModels$default$5(LeaderboardFiltersFlowFragment leaderboardFiltersFlowFragment, ss5 ss5Var) {
        super(0);
        this.u = leaderboardFiltersFlowFragment;
        this.v = ss5Var;
    }
