...
public abstract class Hilt_LeaderboardFiltersFragment extends hk0 implements bk4 {
    public ggb.a v;
    public boolean w;
    ...
    public Hilt_LeaderboardFiltersFragment() {
        super(R.layout.dialog_leaderboard_filters);
        this.w = false;
        this.y = new Object();
        this.z = false;
    }
    ...
    public final void onAttach(Activity activity) {
        ...
        this.z = true;
        LeaderboardFiltersFragment_GeneratedInjector leaderboardFiltersFragment_GeneratedInjector = (LeaderboardFiltersFragment_GeneratedInjector) a();
        leaderboardFiltersFragment_GeneratedInjector.getClass();
    }
