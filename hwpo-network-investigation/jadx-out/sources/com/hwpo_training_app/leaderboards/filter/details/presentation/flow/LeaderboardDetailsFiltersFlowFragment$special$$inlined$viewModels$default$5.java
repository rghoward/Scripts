...
public final class LeaderboardDetailsFiltersFlowFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ LeaderboardDetailsFiltersFlowFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardDetailsFiltersFlowFragment$special$$inlined$viewModels$default$5(LeaderboardDetailsFiltersFlowFragment leaderboardDetailsFiltersFlowFragment, ss5 ss5Var) {
        super(0);
        this.u = leaderboardDetailsFiltersFlowFragment;
        this.v = ss5Var;
    }
