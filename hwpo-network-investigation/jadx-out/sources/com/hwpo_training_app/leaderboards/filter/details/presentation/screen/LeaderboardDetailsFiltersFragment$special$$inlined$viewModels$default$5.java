...
public final class LeaderboardDetailsFiltersFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ LeaderboardDetailsFiltersFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardDetailsFiltersFragment$special$$inlined$viewModels$default$5(LeaderboardDetailsFiltersFragment leaderboardDetailsFiltersFragment, ss5 ss5Var) {
        super(0);
        this.u = leaderboardDetailsFiltersFragment;
        this.v = ss5Var;
    }
