...
public abstract class Hilt_LeaderboardDetailsFiltersFragment extends hk0 implements bk4 {
    public ggb.a v;
    public boolean w;
    ...
    public Hilt_LeaderboardDetailsFiltersFragment() {
        super(R.layout.dialog_leaderboard_details_filters);
        this.w = false;
        this.y = new Object();
        this.z = false;
    }
    ...
    public final void onAttach(Activity activity) {
        ...
        this.z = true;
        LeaderboardDetailsFiltersFragment_GeneratedInjector leaderboardDetailsFiltersFragment_GeneratedInjector = (LeaderboardDetailsFiltersFragment_GeneratedInjector) a();
        leaderboardDetailsFiltersFragment_GeneratedInjector.getClass();
    }
