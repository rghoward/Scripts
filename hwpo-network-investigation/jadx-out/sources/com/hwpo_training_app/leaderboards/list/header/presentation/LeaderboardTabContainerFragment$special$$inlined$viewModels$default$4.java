...
public final class LeaderboardTabContainerFragment$special$$inlined$viewModels$default$4 extends wp5 implements mh4<lb2> {
    public final /* synthetic */ ss5 u;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardTabContainerFragment$special$$inlined$viewModels$default$4(ss5 ss5Var) {
        super(0);
        this.u = ss5Var;
    }
