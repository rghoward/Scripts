...
public abstract class Hilt_LeaderboardTabContainerFragment extends hk0 implements bk4 {
    public ggb.a v;
    public boolean w;
    ...
    public Hilt_LeaderboardTabContainerFragment() {
        super(R.layout.fragment_leaderboards_tab_container);
        this.w = false;
        this.y = new Object();
        this.z = false;
    }
    ...
    public final void onAttach(Activity activity) {
        ...
        this.z = true;
        LeaderboardTabContainerFragment_GeneratedInjector leaderboardTabContainerFragment_GeneratedInjector = (LeaderboardTabContainerFragment_GeneratedInjector) a();
        leaderboardTabContainerFragment_GeneratedInjector.getClass();
    }
