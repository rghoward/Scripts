...
public final class LeaderboardTabContainerFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ LeaderboardTabContainerFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardTabContainerFragment$special$$inlined$viewModels$default$5(LeaderboardTabContainerFragment leaderboardTabContainerFragment, ss5 ss5Var) {
        super(0);
        this.u = leaderboardTabContainerFragment;
        this.v = ss5Var;
    }
