...
public final class ChallengesLeaderboardsFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ ChallengesLeaderboardsFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChallengesLeaderboardsFragment$special$$inlined$viewModels$default$5(ChallengesLeaderboardsFragment challengesLeaderboardsFragment, ss5 ss5Var) {
        super(0);
        this.u = challengesLeaderboardsFragment;
        this.v = ss5Var;
    }
