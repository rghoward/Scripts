...
public final class DailyLeaderboardsFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ DailyLeaderboardsFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DailyLeaderboardsFragment$special$$inlined$viewModels$default$5(DailyLeaderboardsFragment dailyLeaderboardsFragment, ss5 ss5Var) {
        super(0);
        this.u = dailyLeaderboardsFragment;
        this.v = ss5Var;
    }
