...
abstract class Hilt_AthletesListFragment extends hk0 implements bk4 {
    public ggb.a v;
    public boolean w;
    ...
    public Hilt_AthletesListFragment() {
        super(R.layout.fragment_athletes_list);
        this.w = false;
        this.y = new Object();
        this.z = false;
    }
    ...
    public final void onAttach(Activity activity) {
        ...
        this.z = true;
        AthletesListFragment_GeneratedInjector athletesListFragment_GeneratedInjector = (AthletesListFragment_GeneratedInjector) a();
        athletesListFragment_GeneratedInjector.getClass();
    }
