...
public final class AthletesListFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ AthletesListFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AthletesListFragment$special$$inlined$viewModels$default$5(AthletesListFragment athletesListFragment, ss5 ss5Var) {
        super(0);
        this.u = athletesListFragment;
        this.v = ss5Var;
    }
