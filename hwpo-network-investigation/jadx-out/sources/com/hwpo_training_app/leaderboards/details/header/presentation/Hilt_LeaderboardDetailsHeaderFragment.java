...
public abstract class Hilt_LeaderboardDetailsHeaderFragment extends hk0 implements bk4 {
    public ggb.a v;
    public boolean w;
    ...
    public Hilt_LeaderboardDetailsHeaderFragment() {
        super(R.layout.fragment_leaderboards_details_header);
        this.w = false;
        this.y = new Object();
        this.z = false;
    }
    ...
    public final void onAttach(Activity activity) {
        ...
        this.z = true;
        LeaderboardDetailsHeaderFragment_GeneratedInjector leaderboardDetailsHeaderFragment_GeneratedInjector = (LeaderboardDetailsHeaderFragment_GeneratedInjector) a();
        leaderboardDetailsHeaderFragment_GeneratedInjector.getClass();
    }
