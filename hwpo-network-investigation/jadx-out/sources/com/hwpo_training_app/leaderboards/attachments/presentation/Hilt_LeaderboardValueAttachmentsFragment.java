...
public abstract class Hilt_LeaderboardValueAttachmentsFragment extends hk0 implements bk4 {
    public ggb.a v;
    public boolean w;
    ...
    public Hilt_LeaderboardValueAttachmentsFragment() {
        super(R.layout.fragment_leaderboard_value_attachments);
        this.w = false;
        this.y = new Object();
        this.z = false;
    }
    ...
    public final void onAttach(Activity activity) {
        ...
        this.z = true;
        LeaderboardValueAttachmentsFragment_GeneratedInjector leaderboardValueAttachmentsFragment_GeneratedInjector = (LeaderboardValueAttachmentsFragment_GeneratedInjector) a();
        leaderboardValueAttachmentsFragment_GeneratedInjector.getClass();
    }
