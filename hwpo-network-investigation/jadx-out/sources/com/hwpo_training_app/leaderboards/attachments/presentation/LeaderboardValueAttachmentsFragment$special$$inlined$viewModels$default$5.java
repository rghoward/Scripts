...
public final class LeaderboardValueAttachmentsFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ LeaderboardValueAttachmentsFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LeaderboardValueAttachmentsFragment$special$$inlined$viewModels$default$5(LeaderboardValueAttachmentsFragment leaderboardValueAttachmentsFragment, ss5 ss5Var) {
        super(0);
        this.u = leaderboardValueAttachmentsFragment;
        this.v = ss5Var;
    }
