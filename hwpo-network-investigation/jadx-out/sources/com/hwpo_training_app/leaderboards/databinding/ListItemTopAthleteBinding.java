...
public final class ListItemTopAthleteBinding implements wfb {
    ...
    public ListItemTopAthleteBinding(ConstraintLayout constraintLayout, MaterialTextView materialTextView, MaterialTextView materialTextView2, MaterialTextView materialTextView3, MaterialTextView materialTextView4, ShapeableImageView shapeableImageView, MaterialTextView materialTextView5, MaterialButton materialButton) {
    ...
    public static ListItemTopAthleteBinding bind(View view) {
                                    ...
                                    if (((Barrier) nt3.b(R.id.barrier, view)) != null) {
                                        ...
                                        if (((Space) nt3.b(R.id.bottomSpace, view)) != null) {
                                            ...
                                            if (materialButton != null) {
                                                return new ListItemTopAthleteBinding((ConstraintLayout) view, materialTextView, materialTextView2, materialTextView3, materialTextView4, shapeableImageView, materialTextView5, materialButton);
                                            }
                                        }
                                    }
                                }
    ...
    public static ListItemTopAthleteBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.list_item_top_athlete, viewGroup, false);
        if (z) {
    ...
    public static ListItemTopAthleteBinding inflate(LayoutInflater layoutInflater) {
