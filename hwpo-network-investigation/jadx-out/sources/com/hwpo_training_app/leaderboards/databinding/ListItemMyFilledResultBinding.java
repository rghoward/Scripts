...
public final class ListItemMyFilledResultBinding implements wfb {
    ...
    public static ListItemMyFilledResultBinding bind(View view) {
                                            ...
                                            if (((Space) nt3.b(R.id.bottomSpace, view)) != null) {
                                                ...
                                                if (materialTextView7 != null) {
                                                    ...
                                                    if (materialTextView8 != null) {
                                                        return new ListItemMyFilledResultBinding((ConstraintLayout) view, materialTextView, materialTextView2, materialTextView3, materialTextView4, materialTextView5, shapeableImageView, materialTextView6, materialTextView7, materialTextView8);
                                                    }
                                                }
                                            }
                                        }
    ...
    public static ListItemMyFilledResultBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.list_item_my_filled_result, viewGroup, false);
        if (z) {
    ...
    public static ListItemMyFilledResultBinding inflate(LayoutInflater layoutInflater) {
