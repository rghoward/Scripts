...
public final class NotificationsFragment$special$$inlined$viewModels$default$5 extends wp5 implements mh4<thb.c> {
    public final /* synthetic */ NotificationsFragment u;
    public final /* synthetic */ ss5 v;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NotificationsFragment$special$$inlined$viewModels$default$5(NotificationsFragment notificationsFragment, ss5 ss5Var) {
        super(0);
