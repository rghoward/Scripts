...
@gy2
public final /* synthetic */ class NotificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer implements gk4<NotificationNetworkEntity.LeaderboardCommentNotificationNetworkEntity> {
    public static final NotificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer INSTANCE;
    private static final SerialDescriptor descriptor;

    static {
        NotificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer notificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer = new NotificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer();
        INSTANCE = notificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer;
        o48 o48Var = new o48("com.hwpo_training_app.notifications.data.network.push.NotificationNetworkEntity.LeaderboardCommentNotificationNetworkEntity", notificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer, 12);
        o48Var.k("id", false);
    ...
    private NotificationNetworkEntity$LeaderboardCommentNotificationNetworkEntity$$serializer() {
    }

    @Override // defpackage.gk4
    public final KSerializer<?>[] childSerializers() {
        ss5<KSerializer<Object>>[] ss5VarArr = NotificationNetworkEntity.LeaderboardCommentNotificationNetworkEntity.F;
        ue6 ue6Var = ue6.a;
        o2a o2aVar = o2a.a;
    ...
    public final NotificationNetworkEntity.LeaderboardCommentNotificationNetworkEntity deserialize(Decoder decoder) {
        long jG;
        decoder.getClass();
        ...
        return new NotificationNetworkEntity.LeaderboardCommentNotificationNetworkEntity(i, j, notificationTypeNetworkEntity, jG2, str4, str, str3, str2, opponentNetworkEntity, zA0, num, planNetworkEntity, leaderboardScoreCommentNotificationNetworkEntity);
    }
    ...
    public final void serialize(Encoder encoder, NotificationNetworkEntity.LeaderboardCommentNotificationNetworkEntity leaderboardCommentNotificationNetworkEntity) {
        encoder.getClass();
        leaderboardCommentNotificationNetworkEntity.getClass();
        SerialDescriptor serialDescriptor = descriptor;
        st1 st1VarN = encoder.n(serialDescriptor);
        ss5<KSerializer<Object>>[] ss5VarArr = NotificationNetworkEntity.LeaderboardCommentNotificationNetworkEntity.F;
        long j = leaderboardCommentNotificationNetworkEntity.t;
        PlanNetworkEntity planNetworkEntity = leaderboardCommentNotificationNetworkEntity.D;
        Integer num = leaderboardCommentNotificationNetworkEntity.C;
        st1VarN.B(serialDescriptor, 0, j);
        st1VarN.q(serialDescriptor, 1, ss5VarArr[1].getValue(), leaderboardCommentNotificationNetworkEntity.u);
        st1VarN.B(serialDescriptor, 2, leaderboardCommentNotificationNetworkEntity.v);
        o2a o2aVar = o2a.a;
        st1VarN.z(serialDescriptor, 3, o2aVar, leaderboardCommentNotificationNetworkEntity.w);
        st1VarN.z(serialDescriptor, 4, o2aVar, leaderboardCommentNotificationNetworkEntity.x);
        st1VarN.z(serialDescriptor, 5, o2aVar, leaderboardCommentNotificationNetworkEntity.y);
        st1VarN.z(serialDescriptor, 6, o2aVar, leaderboardCommentNotificationNetworkEntity.z);
        st1VarN.q(serialDescriptor, 7, OpponentNetworkEntity$$serializer.INSTANCE, leaderboardCommentNotificationNetworkEntity.A);
        st1VarN.o(serialDescriptor, 8, leaderboardCommentNotificationNetworkEntity.B);
        ...
        st1VarN.q(serialDescriptor, 11, LeaderboardScoreCommentNotificationNetworkEntity$$serializer.INSTANCE, leaderboardCommentNotificationNetworkEntity.E);
