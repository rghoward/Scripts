...
class MovementSubstitutionRegistry {
  ...
  static const _definitions = <_MovementDefinition>[
    ...
    _MovementDefinition(
      'pike_push_up',
      'Pike Push-Up',
      ['box pike push-ups', 'pike push-ups', 'pike push-up'],
      ['Incline Push-Up', 'Dumbbell Strict Press', 'Landmine Press'],
      'Scaled overhead pressing',
    ),
    _MovementDefinition(
      'incline_push_up',
      'Incline Push-Up',
      ['incline push-ups', 'incline push-up'],
      ['Dumbbell Floor Press', 'Ring Push-Up', 'Elevated Push-Up'],
      'Scaled horizontal pressing',
    ),
    _MovementDefinition(
      'power_clean',
      'Power Clean',
