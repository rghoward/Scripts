    ...
    final recipe = switch (family) {
      ...
      14 => _ConditioningRecipe(
        ...
        prescription: [
          ...
          '1:00 easy walking',
          'After each easy minute, complete 8 controlled AbMat sit-ups',
          'Repeat until the clock expires without sprinting the first interval',
        ],
        patterns: const {'cyclical', 'impact', 'core'},
      ...
      17 => _ConditioningRecipe(
        ...
        prescription: [
          ...
          '${12 + add} AbMat sit-ups',
          'Keep every muscle-up technically consistent',
        ],
        patterns: const {'cyclical', 'vertical_pull', 'carry', 'core'},
      ...
      21 => _ConditioningRecipe(
        ...
        prescription: [
          ...
          '12 controlled AbMat sit-ups',
          'Rest as needed to keep each trip between 30 and 40 seconds',
        ],
        patterns: const {'locomotion', 'knee', 'posterior_chain', 'core'},
